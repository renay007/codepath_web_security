...
<div id="main-content">
  <a href="../countries/show.php?id=<?php echo u(h($state['country_id'])); ?>">Back to Country Details</a><br />
...
?>
    ...
    <h2>Territories</h2>
    <br />
    <a href="../territories/new.php?id=<?php echo u(h($id)); ?>">Add a Territory</a><br />

<?php
    $territory_result = find_territories_for_state_id(h($state['id']));
