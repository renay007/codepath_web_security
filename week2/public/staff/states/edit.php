...
$states_result = find_state_by_id(h($_GET['id']));
...
<div id="main-content">
  <a href="show.php?id=<?php echo u(h($state['id'])); ?>">Back to State Details</a><br />

  <h1>Edit State: <?php echo h($state['name']); ?></h1>

  <?php echo display_errors($errors); ?>

  <form action="edit.php?id=<?php echo u(h($state['id'])); ?>" method="post">
    Name:<br />
